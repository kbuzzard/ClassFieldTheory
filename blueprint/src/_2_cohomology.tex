...
\begin{lemma} \label{lem:norm naturality}
	\uses{def:norm}
	\lean{groupCohomology.tateComplex.norm_comm,
		groupCohomology.tateComplex.normNatEnd}
	\leanok
...
\begin{definition}	\label{def:Tate long exact sequence}
  \lean{groupCohomology.TateCohomology.preservesFiniteLimits_tateComplexFunctor,
    groupCohomology.TateCohomology.preservesFiniteColimits_tateComplexFunctor,
