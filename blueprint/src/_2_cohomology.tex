...
\begin{example}
	...
	(or more precisely the triple $(\Z,G,\Z)$)
	is a finite class formation. More generally if $R$ is any commutative ring
	with trivial additive torsion then $(R,G,R)$ is a finite class formation.
	...
	that the cocycle depends on a choice of generator, as in the case $R=\Z$ the
