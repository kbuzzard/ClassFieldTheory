...
$\Cl_k / N_{l/k} \Cl_l$.
Furthermore, the inflation map for a tower of Galois extensions $l/m/k$ takes the form
\[
...
% 	Let's suppose that there does exist an analytic continuation to some neighbourhood of $0$.
...
% 	\]
% 	The inner series in the above expression is the power series expansion of $n^{-\epsilon}$,
